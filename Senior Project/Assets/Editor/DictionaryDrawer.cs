...
[CustomPropertyDrawer(typeof(CustomStats))] // Name of your class (same as above)
public class CustomStatsDrawer : DictionaryDrawer<StatType, float> { } // chose same types as your dictionary
